...
| 31.5 Deep-research bronintake en top-layer verificatie | open | Intakes verwerkt voor `docs/dr/Healthy school.md`, `docs/dr/Digital and operational infrastructure.md`, `docs/dr/Informal support.md` en `docs/dr/Zorgzaam Flevoland, and Flever interface.md`. Geselecteerde bronnen gaan door manifest/pipeline en worden getoetst in D6-register/reviewlagen; intake-notities staan in `docs/source-intake/`. |

## Huidige sprintplan
Sprint 31.5 is open. De lopende taak is deep-research intake voor `docs/dr/Zorgzaam Flevoland, and Flever interface.md`: het rapport blijft een signaal, geselecteerde publieke bronnen gaan door de manifest/pipeline, en daarna wordt gecontroleerd of de bevindingen zichtbaar zijn in de top data layers. Sprint 25.6 blijft geparkeerd omdat post-validatie hardening pas verantwoord is na stakeholdervalidatierecords, lokale/interne documenten, finance/controller bevestiging of een expliciet beleidsbesluit.
...
Status op 30 april 2026: Sprint 31.5 heeft vier deep-research rapporten als bronsignaal verwerkt, niet als bewijsbron: `docs/dr/Healthy school.md`, `docs/dr/Digital and operational infrastructure.md`, `docs/dr/Informal support.md` en `docs/dr/Zorgzaam Flevoland, and Flever interface.md`. De geselecteerde publieke bronnen zijn opgeslagen, toegevoegd aan de manifestlaag, door de pipeline gehaald en daarna getoetst in het D6-register en reviewmateriaal. Gezonde School, digitale/operationele infrastructuur, inloopvoorzieningen, burgerinitiatieven/informele steun en de PGA/Zorgzaam/Flever-interface hebben nu sterkere publieke prefill, maar blijven `inferred` en `needs_human_review`; formele D6-classificatie, eigenaarschap, mandaat en financiering blijven stakeholder- of beleidsvalidatie.
