...
Roadmap version: `v2026.05.09-10`.
...
| --- | --- | --- |
| `docs/review/D5_validatieformat_werkagenda_Almere_v0.10.xlsx` | Current Excel workbook, 18 sheets; 10 visible component input sheets and 8 hidden instruction/navigation/control/workflow sheets. Prior versions preserved. | D5 pre-contact validation instrument for P5 dry run; keeps all non-input tabs out of the human-facing tab bar while preserving them for repository processing. |
