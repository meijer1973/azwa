...
| 32.0 Werkagenda-delivery scope en stuurmodel | open | Gestart met `docs/workagenda-d5-stuurmodel.md` en `data/workagenda/d5_stuurmodel.json`: scope, statusmodel, mijlpalen, bestandskeuzes en guardrails vastzetten voordat D5-statusmatrix of validatie-Excel wordt gebouwd. |

## Huidige sprintplan
Sprint 32.0 is open. De lopende taak is het werkagenda-delivery stuurmodel vastzetten: D5-scope, delivery-statussen, werkagendavelden, mijlpalen, geplande kernbestanden en guardrails. Sprint 31.5 is afgerond. Sprint 25.6 blijft geparkeerd omdat post-validatie hardening pas verantwoord is na stakeholdervalidatierecords, lokale/interne documenten, finance/controller bevestiging of een expliciet beleidsbesluit.
