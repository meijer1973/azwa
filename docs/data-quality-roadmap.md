...
| 31.5 Deep-research bronintake en top-layer verificatie | open | Intakes verwerkt voor `docs/dr/Healthy school.md`, `docs/dr/Digital and operational infrastructure.md`, `docs/dr/Informal support.md`, `docs/dr/Zorgzaam Flevoland, and Flever interface.md`, `docs/dr/Samen Sterker in de Wijk in Almere.md`, `docs/dr/Almere D6 Settlement Evidence Audit.md` en `docs/dr/Stable public source check for “Stand van zaken Gezondheidsbeleid (IZA en GALA)”.md`. Geselecteerde bronnen gaan door manifest/pipeline en worden getoetst in D6-register/reviewlagen; niet-claim-ready landingpagina's blijven bronintake-kandidaat. |
