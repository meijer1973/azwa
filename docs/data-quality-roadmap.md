...
| --- | --- | --- |
| `docs/review/D5_validatieformat_werkagenda_Almere_v0.7.xlsx` | Current Excel workbook, 18 sheets; prior versions preserved. | D5 pre-contact validation instrument for P5 dry run; uses plain-language `pilot`, `pilotregio` and `in de praktijk uitproberen` wording for optional new development-agenda items. |
