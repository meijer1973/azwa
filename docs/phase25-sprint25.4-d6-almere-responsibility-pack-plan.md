...
| 24.8 Local validation preparation | completed | Interne validatiepack gearchiveerd: `docs/review/archive/d6-support/almere_d6_validation_pack.md`; actuele menselijke ingang: `docs/review/almere_d6_open_questions.md` |
