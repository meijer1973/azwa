...
0. Read `validation-instrument-register.md`, `validation-workbook-traceability-audit.md`, and `validation-workbook-prefill-audit.md` if you are working with the D5 or D6 Excel validation workbooks.
