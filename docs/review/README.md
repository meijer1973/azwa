...
0. Read `validation-instrument-register.md` and `validation-workbook-traceability-audit.md` if you are working with the D5 or D6 Excel validation workbooks.
