...
| Samen Sterker in de Wijk / mentale-gezondheidswijkinfrastructuur | Is this formal D6 infrastructure, supporting infrastructure, adjacent PGA/mental-health implementation, or a separate project? | `inferred` | Gemeente Almere, GGD Flevoland, GGZ/welfare partners, Zorgplatform Flevoland, finance/controller validation | Shared responsibility needs validation | Zorgplatform Flevoland partners, GGZ Centraal, GGD Flevoland, Zorggroep Almere, Triade Vitree, Kwintes, Leger des Heils, local professionals and ervaringsdeskundigen are candidates | Almere local and regional project scale | Municipal subsidy trace and PGA/IZA/ZonMw context visible; structural D6/component funding unknown | `mun_almere_samenwerkingsprojecten`, `reg_almere_zorglandschap_wmo`, `reg_zorglandschap_wmo_uitvoeringsprogramma_2022`, `reg_zorglandschap_wmo_monitor_2025`, ZonMw sources, `mun_almere_pga_samen_sterker_wijk`, subsidy/evaluation/project-site sources |
| Positief Gezond Almere / Zorgzaam Flevoland-interface | How are PGA, Zorgzaam/Flever, GGD and AZWA work-agenda roles separated? | `inferred` | PGA/Zorgzaam Flevoland/Flever, GGD Flevoland, Gemeente Almere, regional governance | Shared programme and regional roles need validation | PGA programme, Zorgzaam Flevoland regional structure, Flever participation support and GGD monitoring/advice are candidates | Almere local and IZA/AZWA Flevoland | IZA/PGA transformation funding context; GALA/SPUK prevention and knowledge context; AZWA/D5/D6 split needed | `mun_almere_pga_transformatieplan`, `mun_almere_pga_current_home`, `nat_zorgakkoorden_pga_20_miljoen_2024`, `reg_flevoland_2023_regioplan_iza`, `reg_zonmw_doorontwikkeling_zorgzaam_flevoland`, `reg_ggd_flevoland_kadernota_2025`, `reg_ggd_flevoland_begroting_2026`, Flever sources |
...
| Samen Sterker in de Wijk | `inferred` | Not yet validated | No | Public sources show Samen Sterker as an active mental-health neighbourhood initiative with municipal, Zorglandschap Wmo, ZonMw, PGA and project-site evidence; it is a strong validation candidate for D6-related wijkinfrastructure. | Samen Sterker is formal D6 infrastructure, has a settled D6 owner, is structurally funded as D6, or is formally linked to SLT. |
| PGA / Zorgzaam Flevoland-interface | `inferred` | Not yet validated | No | Public sources suggest an interface of local programme, regional collaboration/governance development, resident-participation support and GGD monitoring/advice; local validation is still needed for D6 classification, owner, mandate and funding. | PGA/Zorgzaam/Flever is the D6 governance vehicle, or one of these actors owns D6 for Almere. |
...
Rows remaining `review_needed`: none.
...
- Zorglandschap Wmo programme and Monitor 2025 sources.
- ZonMw Samen Sterker project pages.
- PGA Samen Sterker in de Wijk project page.
- Almere subsidy register 2023, Evaluatie schakelteams and Samen Sterker project-site context.
