...
| --- | --- | ---: | --- |
| D5 validatieformat werkagenda Almere | `docs/review/D5_validatieformat_werkagenda_Almere_v0.1.xlsx` | 154 | Traceability map created; workbook still lacks visible per-row metadata fields. |
