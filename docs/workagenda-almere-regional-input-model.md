...
## What This Layer Is
`data/workagenda/almere_regional_workagenda_input_objects.json` is generated by `src/build_almere_regional_workagenda_input.py`. It creates one object per D5 status-matrix row and translates the current repository steering layers into policymaker-readable input objects for Almere.
