...
ANNOTATIONS = {
    ...
    "mun_almere_subsidieregister_2024": {
        ...
        "contains_monitoring_evaluation_logic": False,
        "contains_municipal_implications": True,
        "inventory_notes": "Municipal subsidy register for 2024; useful for JGZ, GGD, Wijkteams, social-base and partner funding traces, not D6 allocation proof.",
    },
    "mun_almere_subsidieregister_2025": {
        ...
        "contains_monitoring_evaluation_logic": False,
        "contains_municipal_implications": True,
        "inventory_notes": "Municipal subsidy register for 2025; useful for current JGZ, GGD, SLT-related and partner funding traces, not D6 allocation proof.",
    },
    "mun_almere_mentale_gezondheid": {
        ...
        "contains_monitoring_evaluation_logic": False,
        "contains_municipal_implications": True,
        "inventory_notes": "Municipal mental-health page for youth/prevention context and local implementation evidence; not a D6 classification or owner decision.",
    },
    "reg_ggd_flevoland_voortgang_gala_regio_2023": {
        ...
        "contains_monitoring_evaluation_logic": True,
        "contains_municipal_implications": True,
        "inventory_notes": "GGD Flevoland governance note on GALA/IZA regional progress; useful for BOSD/GGD role and regional governance context, not Almere D6 mandate.",
    },
    "nat_zorgakkoorden_werkagenda_handvatten_2026": {
        ...
        "contains_monitoring_evaluation_logic": True,
        "contains_municipal_implications": True,
        "inventory_notes": "Canonical Zorgakkoorden handvatten page for regional workagenda process; national process source, not proof of Almere adoption.",
    },
    "reg_ggd_flevoland_valpreventie_lelystad_2025": {
        ...
        "contains_governance_logic": True,
        "contains_monitoring_evaluation_logic": True,
        "contains_municipal_implications": False,
        "inventory_notes": "Local Flevoland valpreventie ketendocument with operational role, referral, declaration and monitoring artifacts; useful as a D5 execution comparator, not Almere proof.",
    },
    "reg_amstellandzorg_welzijn_op_recept_procesflow_2024": {
        ...
        "contains_monitoring_evaluation_logic": True,
        "contains_municipal_implications": False,
        "inventory_notes": "Regional Welzijn op Recept processflow with referral, HIS/ZorgDomein, feedback and dashboard signals; reusable operational comparator, not Almere adoption proof.",
    },
    "reg_ros_friesland_zorgpad_vroegsignalering_zwangeren_2024": {
        ...
        "contains_monitoring_evaluation_logic": False,
        "contains_municipal_implications": False,
        "inventory_notes": "Regional care pathway for vulnerable pregnancies and PHB-JGZ referral logic; useful for D5 Kansrijke Start operational design, not Almere implementation proof.",
    },
    "reg_samen_nijmegen_protocol_kwetsbare_zwangere_2024": {
        ...
        "contains_monitoring_evaluation_logic": False,
        "contains_municipal_implications": False,
        "inventory_notes": "Public VSV protocol for vulnerable pregnancy routing, target groups, PHB-JGZ/kraamzorg and MDO rules; useful as an operational protocol comparator.",
    },
    "nat_kind_naar_gezonder_gewicht_monitoring_matrix_2023": {
        ...
        "contains_monitoring_evaluation_logic": True,
        "contains_municipal_implications": True,
        "inventory_notes": "Reusable Kind naar Gezonder Gewicht monitoring and evaluation matrix; useful for D5 overgewicht kinderen and monitoring-field design.",
    },
    "nat_leidraad_consultatiefunctie_ggz_sociaal_domein_2024": {
        ...
        "contains_monitoring_evaluation_logic": False,
        "contains_municipal_implications": True,
        "inventory_notes": "National leadraad for consultative GGZ function in the social domain; useful for D6 regional plan and contracting logic, not local Almere role assignment.",
    },
    "nat_pharos_brugfuncties_huisartsenzorg_sociaal_domein_2025": {
        ...
        "contains_monitoring_evaluation_logic": True,
        "contains_municipal_implications": True,
        "inventory_notes": "National handreiking on bridge functions between GP care and the social domain; useful for D5-D6 dependency and role-language design, not Almere mandate proof.",
    },
    "reg_ggd_flevoland_valpreventie_almere_ketendocument_2026": {
        ...
        "contains_monitoring_evaluation_logic": True,
        "contains_municipal_implications": True,
        "inventory_notes": "Almere-specific valpreventie ketendocument PDF with operational route, role, declaration and monitoring content; strengthens D5 operational source base but does not settle D6 ownership or funding.",
    },
}
