...
LATEST_UPDATE_ID = "upd_samen_sterker_wijk_intake_2026_05_01"
...
class SiteGenerationTests(unittest.TestCase):
    ...
    def test_updates_page_contains_current_change_log(self) -> None:
        ...
        self.assertIn("Samen Sterker in de Wijk sterker onderbouwd", html)
        self.assertIn("Kort samengevat", html)
        self.assertIn("Negen publieke bronnen rond Zorglandschap Wmo", html)
        self.assertIn('../sources/monitor-zorglandschap-wmo-2025/index.html', html)
        ...
        self.assertIn("Zorglandschap Wmo geeft regionale programma- en monitorcontext", html)
        self.assertIn("ZonMw en PGA geven project- en transformatiecontext", html)
        self.assertIn("Gemeentelijke bronnen geven extra Almere-context", html)
